...
import os
import urllib.parse
from sonyscraper import showName
from sonyscraper import season_num
...
def give_link(cleaned_numeric_value, cleaned_show_name):
    ...
    for key in keys:
        ...
        title = f'{showName} - S{season_num}E{indexz}'
...
def subs(cleaned_numeric_value, cleaned_show_name):
    ...
    title = f'{showName} - S{season_num}E{index}.srt'
    command = ['yt-dlp', '-o', title, subtitles]
    subprocess.run(command, check=True)
    title = f'{showName} - S{season_num}E{index}'
    titles = f'{showName} - S{season_num}E{index}.srt'
